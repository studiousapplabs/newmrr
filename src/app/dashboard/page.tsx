...
function DashboardContent() {
  ...
  const RESOURCES = [
    { category: 'The Grind', title: 'Outreach Script (TAG Formula)', desc: 'Tell/Ask/Go — the exact script for landing first customers', tag: 'Script' },
    { category: 'The Grind', title: 'Gateway Product Launch Checklist', desc: '14 steps from zero to first paid customer', tag: 'Checklist' },
    { category: 'The Growth', title: 'Stack the Deck: Pre-Launch Playbook', desc: '1000/10/1 influencer activation method', tag: 'Playbook' },
    { category: 'The Growth', title: '5-Email Welcome Sequence', desc: 'Turns signups into buyers within 7 days', tag: 'Templates' },
    { category: 'The Growth', title: 'Pricing Calculator Worksheet', desc: 'Find your $30 sweet spot with margin math', tag: 'Worksheet' },
    { category: 'The Gold', title: 'Product Stacking Framework', desc: 'How to launch product #2–4 to your existing audience', tag: 'Framework' },
    { category: 'The Gold', title: 'Exit Readiness Checklist', desc: 'Build a sellable brand from day one', tag: 'Checklist' },
    { category: 'The Gold', title: '7 Email Flows for Recurring Revenue', desc: 'Welcome → Post-purchase → Re-engagement sequences', tag: 'Templates' },
  ]
        ...
        <div>
          ...
          <div className="grid-2" style={{ gap: 16 }}>
            <div className="card" style={{ padding: 24 }}>
              ...
              <h3 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: 8, lineHeight: 1.3 }}>{result.gatewayProduct}</h3>
        ...
        <div>
          ...
          <div className="card-sm" style={{ marginTop: 20, borderColor: 'rgba(201,168,76,0.2)' }}>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: 1.7 }}>
              <strong style={{ color: 'var(--gold)' }}>Moran&apos;s rule:</strong> You don&apos;t get 25 sales/day by building complex systems. You get there by doing small things consistently — one customer, one review, one post at a time.
            </p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'calculator' && (
        <div>
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
              Adjust the inputs to model your $1M path. Moran&apos;s formula: products × customers × price.
            </p>
          </div>
                    ...
                    <div key={r.title} className="card-sm" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0, marginLeft: 16 }}>
                        ...
                        <button style={{
                          ...
                          color: 'var(--text-muted)', fontSize: '0.78rem', padding: '4px 10px', cursor: 'pointer',
                        }}>
                          Download
                        </button>
                      </div>
